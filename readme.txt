...
7. To use the audio testimonials plugin, place `[nearbynowtestimonials playlist="happy"]` in your templates
...
== Changelog ==
= 1.8.8 =
* Update to API v3 (Map Theme Support)

= 1.8.6 =
* Added ability to hide the mini-map on reviews
* Added ability to hide checkin photos
